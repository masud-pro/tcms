...
class AmarpayController extends Controller {
    public function index() {
        ...
        $fields = array(
            'store_id'      => env( "AMARPAY_ID" ), //store id will be aamarpay,  contact integration@aamarpay.com for test/live id
            ...
            'cancel_url'   => '/cancel', //your cancel url
            'opt_a'    => 'Reshad', //optional paramter
            'opt_b'   => 'Akil',
            'opt_c'         => 'Liza',
            'opt_d'         => 'Sohel',
            'signature_key' => env( "AMARPAY_SIGNATURE" ) ); //signature key will provided aamarpay, contact integration@aamarpay.com for test/live signature key
