    ...
    @if (Auth::user()->is_active == 1 || Auth::user()->hasRole(['Super Admin']))
        ...
        @role('Super Admin')
            <li class="nav-item {{ request()->is('administrator.*') ? 'active' : '' }}">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#administrator" aria-expanded="true" aria-controls="administrator">
                    <i class="fas fa-users-cog"></i>
                    <span>Administrator</span>
                </a>

                <div id="administrator" class="collapse {{ request()->routeIs('administrator.*') ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">User Operations:</h6>
                        <a class="collapse-item {{ request()->is('administrator') ? 'active' : '' }}" href="{{ route('administrator.index') }}">All User</a>
        ...
        @if (auth()->user()->hasRole(['Teacher', 'Super Admin']))
            ...
            @if (hasCourseAccess())
                <li class="nav-item {{ request()->routeIs('course.*') ? 'active' : '' }} ">
                    ...
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#batchCollapse" aria-expanded="true" aria-controls="batchCollapse">
            ...
            @if (hasExamQuestionAccess())
                <li class="nav-item {{ request()->routeIs('questions.*') ? 'active' : '' }}">
                    ...
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#assessmentCollaple" aria-expanded="true" aria-controls="assessmentCollaple">
                        <i class="fas fa-pen"></i>
                        <span>Exam Questions</span>
                    </a>

                    <div id="assessmentCollaple" class="collapse {{ request()->routeIs('questions.*') ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Assessment Operations:</h6>
                            <a class="collapse-item {{ request()->is('questions') ? 'active' : '' }}" href="{{ route('questions.index') }}">All Questions</a>
                            <a class="collapse-item {{ request()->is('questions/create') ? 'active' : '' }}" href="{{ route('questions.create') }}">Create Questions</a>
                        </div>
                    </div>
            ...
            @if (hasAttendanceAccess())
                <li class="nav-item {{ request()->is('attendance*') ? 'active' : '' }}">
                    ...
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#attendaceCollapse" aria-expanded="true" aria-controls="attendaceCollapse">
            ...
            @if (hasAccountAccess())
                <li class="nav-item {{ request()->routeIs('account*') ? 'active' : '' }}">
                    ...
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#paymentsCollapse" aria-expanded="true" aria-controls="paymentsCollapse">
            ...
            @if (hasTransactionsAccess())
                ...
                <li class="nav-item {{ request()->is('*transactions') ? 'active' : '' }}">
                    ...
                    <div id="transactionCollapse" class="collapse {{ request()->routeIs('*transactions') ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Transactions Operations:</h6>
                            <a class="collapse-item {{ request()->routeIs('student.transactions') ? 'active' : '' }}" href="{{ route('student.transactions') }}">Student Transactions</a>
                            <a class="collapse-item {{ request()->routeIs('my.transactions') ? 'active' : '' }}" href="{{ route('my.transactions') }}">My Transactions</a>
                        </div>
                    </div>
            ...
            @if (hasMassageAccess())
                <li class="nav-item {{ request()->routeIs('sms*') ? 'active' : '' }}">
                    ...
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#smsCollapse" aria-expanded="true" aria-controls="smsCollapse">
