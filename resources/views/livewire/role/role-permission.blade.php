                ...
                <div class="col-md-12">
                    <div class="form-check mt-3 mb-3">
                        <input class="form-check-input" id="selectAll" wire:click="checkedAll" type="checkbox"
                            {{ $allChecked == count($allPermissions) ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input checkbox" type="checkbox" value="courses.index"
                                    ...
                                    {{ in_array('courses.index', $allPermissions) ? 'checked' : '' }} id="coursesIndex">
                            ...
                            <div class="form-check">
                                <input class="form-check-input checkbox" type="checkbox" value="courses.edit"
                                    wire:model="selectedPermissions"
                                    {{ in_array('courses.edit', $allPermissions) ? 'checked' : '' }} id="coursesEdit">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="feed.create"
                                    wire:model="selectedPermissions"
                                    {{ in_array('feed.create', $allPermissions) ? 'checked' : '' }} id="feedCreate">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="feed.destroy"
                                    wire:model="selectedPermissions"
                                    {{ in_array('feed.destroy', $allPermissions) ? 'checked' : '' }} id="feedDestroy">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="student.edit"
                                    wire:model="selectedPermissions"
                                    {{ in_array('student.edit', $allPermissions) ? 'checked' : '' }} id="studentEdit">
                ...
                <div class="col-md-6 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="exam_question.assigned_course"
                                    wire:model="selectedPermissions"
                ...
                <div class="col-md-6 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="attendance.course_students"
                                    wire:model="selectedPermissions"
                ...
                <div class="col-md-6 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="accounts.overall_user_account"
                                    wire:model="selectedPermissions"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="accounts.individual_student"
                                    wire:model="selectedPermissions"
                ...
                <div class="col-md-6 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="settings.individual_teacher"
                                    wire:model="selectedPermissions"
