                            ...
                            @if (auth()->user()->can('feed.edit'))
                                <div class="dropdown no-arrow">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" href="{{ route('feeds.edit', ['course' => $course->id, 'type' => 'post', 'feed' => $feed->id]) }}">Edit
                                            post</a>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                @if (Illuminate\Support\Str::wordCount($feed->description) > 50)
                                    <a data-toggle="collapse" href="#collapseExample{{ $feed->id }}" role="button" aria-expanded="false" aria-controls="collapseExample">Read More</a>
                                @endif
                            </p>
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            @if (auth()->user()->role == 'Admin')
                                <div class="dropdown no-arrow">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                        {{-- <div class="dropdown-header">Options</div> --}}
                                        <a class="dropdown-item" href="{{ route('feeds.edit-link', ['course' => $course->id, 'type' => 'link', 'feed' => $feed->id]) }}">Edit
                                            Link</a>
                                        <form action="{{ route('feeds.destroy', ['feed' => $feed->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
