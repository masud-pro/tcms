                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch ml-3">
                                <input wire:change="change_status({{ $user->id }},{{ $user->is_active }})" class="form-check-input" type="checkbox" @if ($user->is_active == 1) checked @endif
                        ...
                        <td>
                            <a class="btn btn-primary" href="{{ route('administrator.edit', $user->id) }}" target="_blank">
                                Edit
                            </a>
                        </td>
