<div>
    ...
    <form wire:submit.prevent="update">
        ...
        <div wire:ignore>
            ...
            <select class="form-control" multiple="multiple" id="user_id">
            ...
            <input value="{{ old('start_time') }}" wire:model="form.start_time" class="form-control" id="start_time"
                type="text">
            ...
            <input value="{{ old('deadline') }}" wire:model="form.deadline" class="form-control" id="deadline"
                type="text">
    ...
    <form method="POST" action="{{ route('assessments.destroy', ['assessment' => $assessment->id]) }}"
        class="text-center">
