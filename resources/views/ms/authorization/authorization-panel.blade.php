    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="{{ route('course.users.reauthorize', ['course' => request()->course]) }}">
                @csrf
                <input type="submit" value="Reauthorize Students"
                    onclick="return confirm('Are you sure you want to re authorize students')" class="mb-3 btn btn-primary">
            </form>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input {{ $student->pivot->is_active == 1 ? 'checked' : '' }}
                                                        name="students[]" value="{{ $student->id }}" type="checkbox"
                                                        class="custom-control-input" id="customCheck{{ $student->id }}">
                                                    <label class="custom-control-label"
                                                        for="customCheck{{ $student->id }}">Authorized</label>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
