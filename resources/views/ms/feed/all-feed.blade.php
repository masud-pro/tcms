            ...
            @if (Auth::user()->role == 'Admin' || $is_active == 1)
                <div class="">
                    @if (auth()->user()->role == 'Admin')
                        <div class="btn-group mb-4">
                            ...
                            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{ route('course.feeds.create', ['course' => $course->id]) }}">
                                    Create Post
                                </a>
                    ...
                    @if (auth()->user()->role == 'Admin' || $canSeeFriends)
                        <a class="btn btn-primary mb-4" href="{{ route('course.students', ['course' => $course->id]) }}">
                            See Students
                        </a>
                    @endif
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Paid Payments</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $paid }}
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Unpaid Payments</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $unpaid }}
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @if ($course->class_link)
                                                            <div class="row no-gutters align-items-center mt-3">
                                                                <div class="col mr-2">
                                                                    ...
                                                                    <a href="{{ $course->class_link }}" class=""
                                                                        target="_blank"
                                                                        rel="course link">{!! $course->class_link !!}</a>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <i class="fas fa-info fa-2x text-gray-300"></i>
                                                                    {{-- <i class="fas fa-calendar "></i> --}}
                                                        ...
                                                        <div class="row no-gutters align-items-center mt-3">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="p mb-0 text-gray-800">{{ $course->address }}
                                                                    <span class="small"> - <b>Room No:</b>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="h5 mb-0 text-gray-800">{{ $course->subject }}
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="h5 mb-0 text-gray-800">{{ $course->section }}
                                                                    - <span class="small"><b>Time:</b>
                                                                        {{ $course->time }}</span></div>
                                                            </div>
                                                            <div class="col-auto">
                ...
                <div class="text-center">
                    ...
                    @if ($unpaid)
                        ...
                        <a href="{{ route('account.student.individual', ['status' => 'Unpaid']) }}"
                            class="btn btn-block w-25 mx-auto btn-success mt-4">Pay Now</a>
                    @else
