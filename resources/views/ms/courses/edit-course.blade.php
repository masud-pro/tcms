            ...
            <form action="{{ route('course.update', ['course' => $course->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <textarea name="address" id="address" rows="2" class="form-control">{{ old('address') ?? $course->address }}</textarea>
                        @error('address')
                            <p class="text-danger small mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input name="class_link" id="class_link" rows="2" class="form-control" value="{!! old('class_link') ?? $course->class_link !!}">
                        @error('class_link')
                            <p class="text-danger small mt-1">{{ $message }}</p>
                        @enderror
                    </div>
