                        ...
                        <tbody>
                            @foreach ($courses as $course)
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="{{ route("course.edit",[ 'course' => $course->id ]) }}">Edit</a></td>
                                    <td><a class="btn btn-primary" href="{{ route("course.students",["course"=>$course->id ]) }}">Students</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
